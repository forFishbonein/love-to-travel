...
<template>
  ...
  <nav>
    <div class="menu">
      <p class="website_name">
        <router-link to="/"
          ><img src="/images/resources/love-to-travel-logo-touming.png" alt=""
        /></router-link>
      </p>
      <div class="menu_icon">
        <span class="icon"></span>
  ...
  <section class="wrapper">
    <div class="container">
      ...
      <div class="text">
        <article>
          <p>哦吼！亲爱的爱宝儿你好像走丢了~<br />点击下方可以回到首页</p>
          <button><router-link to="/">回到首页</router-link></button>
        </article>
      </div>
    </div>
  </section>
...
$g-02: linear-gradient(90deg, #e8604c 13.7%, #e6a23c 94.65%);
...
.wrapper {
  ...
  height: 100vh;
  overflow-x: hidden;
  background-color: rgba(167, 61, 61, 0.4);
